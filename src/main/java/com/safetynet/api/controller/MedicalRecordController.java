...
public class MedicalRecordController extends Controller {
    ...
    public ResponseEntity<MedicalRecordDto> delete(@RequestBody MedicalRecordDto dto) {
	return ResponseEntity.status(HttpStatus.OK).body(medicalRecordService.delete(dto));
    }
